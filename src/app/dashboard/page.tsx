      ...
      <header className="sticky top-0 z-30 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a href="/settings" className="flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-700 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                          ...
                          {link.source === "extension" && (
                            <span className="text-xs bg-violet-50 text-violet-600 px-1.5 py-0.5 rounded-md flex items-center gap-0.5 font-medium">
